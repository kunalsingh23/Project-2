...
print (num_students(get_umsi_data()))
...
def main():
    ...
    total += test(grab_headlines(),["Michigan football players protest racism in act of unity", "Students attempt to shut down speech by controversial social scientist Charles Murray", 'Pod Save America tour discusses student activism, healthcare in Ann Arbor stop', "SportsMonday Column: The monkey on Jim Harbaugh's back", 'Op-Ed: Silencing bigoted voices'],50)
